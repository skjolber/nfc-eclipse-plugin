package com.google.zxing.qrcode.binary.encoder;
/*
...
public final class Encoder {
   ...
   */
  public static void encode(byte[] content, ErrorCorrectionLevel ecLevel, QRCode qrCode)
  ...
  static void append8BitBytes(byte[] bytes, BitArray bits)
      throws WriterException {
    for (byte b : bytes) {
      bits.appendBits(b, 8);
    }
